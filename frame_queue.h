...
static inline int frame_queue__init(struct frame_queue *fq, u16 size)
{
...
static inline void frame_queue__prod_fill(struct frame_queue *fq, u16 offset, u64 addr)
{
...
static inline u64 frame_queue__cons_fetch(struct frame_queue *fq, u16 offset)
{
	return fq->addrs[(fq->cons + offset) & fq->index_mask] << XSK_UMEM__DEFAULT_FRAME_SHIFT;
}

static inline void frame_queue__pop(struct frame_queue *fq, u16 num)
{
